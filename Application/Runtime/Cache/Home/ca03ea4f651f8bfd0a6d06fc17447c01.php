...
<div class="row col-xs-10 activity">
	<ul class="list-group">
	  <li class="list-group-item">
	  	<div class="row col-xs-2">活动名称</div>
	  	<div class="row col-xs-4">活动内容</div>
	  	<div class="row col-xs-2">开始时间</div>
	  	<div class="row col-xs-2">结束时间</div>
	  	<div class="row col-xs-2">状态</div>
	  </li>

	  <?php if(is_array($activityArr)): $i = 0; $__LIST__ = $activityArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list-group-item">
	  		<div class="row col-xs-2"><?php echo ($vo["title"]); ?></div>
	  		<div class="row col-xs-4"><?php echo ($vo["content"]); ?></div>
	  		<div class="row col-xs-2"><?php echo ($vo["start_datetime"]); ?></div>
	  		<div class="row col-xs-2"><?php echo ($vo["end_datetime"]); ?></div>
		  	<div class="row col-xs-2">
